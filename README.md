...
### WIP slash commands
`/next` -> posts next game time
`/schedule` -> posts full schedule message
`/prev` -> posts previous game/score

## Docker image

There are amd64 and arm images at hub.docker.com/repository/docker/kingkaffee/w2wbot/
